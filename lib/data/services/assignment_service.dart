  ...
  List<AssignmentModel> loadAssignedAssignments() {
    ...
    final seeded = [
      AssignmentModel(
        ...
        description:
            'Lecturer-posted assignment: explain graph traversal, compare breadth-first and depth-first search, include pseudocode for detecting cycles, and upload your final PDF submission.',
        lecturerName: 'Dr. Musa',
        assignedAt: now.subtract(const Duration(days: 2)),
        deadline: DateTime(2026, 6, 18, 17),
      ...
      AssignmentModel(
        id: 'asmt-csc309-ai-search',
        courseCode: 'CSC 309',
        title: 'AI Search Strategy Report',
        description:
            'Lecturer-posted assignment: prepare a short report comparing uninformed and informed search strategies, include examples, complexity notes, and any implementation trace used.',
        lecturerName: 'Dr. Musa',
        assignedAt: now.subtract(const Duration(days: 3)),
        deadline: DateTime(2026, 6, 20, 17),
        whiteboardEnabled: true,
        whiteboardRequired: false,
        whiteboardPrompt:
            'Optional: sketch the search tree or frontier expansion order.',
        peerReview: AssignmentPeerReviewConfig(
          id: 'peer-csc309-zainab-to-isa',
          target: const AssignmentPeerReviewTarget(
            id: 'std-isa',
            name: 'Isa Muhammad',
            registrationNumber: 'KASU/CSC/21/212',
            submissionId: 'sub-csc309-isa',
          ),
          deadline: now.add(const Duration(days: 5)),
          rubric: const [
            'Search strategy comparison is accurate',
            'Examples are tied to the algorithm',
            'Complexity notes are clear',
          ],
        ),
      ),
      AssignmentModel(
        id: 'asmt-sen301-requirements',
        courseCode: 'SEN 301',
        title: 'Requirements Specification Draft',
        description:
            'Lecturer-posted assignment: submit a requirements specification draft with functional requirements, non-functional requirements, user roles, and acceptance criteria.',
        lecturerName: 'Engr. H. Sani',
        assignedAt: now.subtract(const Duration(days: 1)),
        deadline: DateTime(2026, 6, 15, 12),
        peerReview: AssignmentPeerReviewConfig(
          id: 'peer-sen301-zainab-to-blessing',
          target: const AssignmentPeerReviewTarget(
            id: 'std-blessing',
            name: 'Blessing Okafor',
            registrationNumber: 'KASU/SEN/21/088',
            submissionId: 'sub-sen301-blessing',
          ),
