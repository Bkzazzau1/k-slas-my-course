        ...
        child: CustomScrollView(
          slivers: [
            ...
            SliverPadding(
              padding: const EdgeInsets.fromLTRB(16, 0, 16, 12),
              sliver: SliverToBoxAdapter(
                child: _UnofficialTranscriptPreview(courses: _courses),
              ),
            ),
            SliverPadding(
        ...
        children: [
            ...
            children: [
              SizedBox(
                ...
                child: DropdownButtonFormField<String>(
                  ...
                  items: const [
                    DropdownMenuItem(
                      value: 'Electronic official copy',
                      child: Text('Electronic official copy'),
                    ),
                    DropdownMenuItem(
                      value: 'Sealed physical copy',
                      child: Text('Sealed physical copy'),
                    ),
                    DropdownMenuItem(
                      value: 'Both electronic and sealed',
                      child: Text('Both electronic and sealed'),
                    ),
                  ],
          ...
          const TextField(
            decoration: InputDecoration(
              labelText: 'Recipient institution / organization',
            ),
          ),
          const SizedBox(height: 10),
          const TextField(
            decoration: InputDecoration(
              labelText: 'Recipient email or delivery address',
            ),
          ),
          const SizedBox(height: 12),
          Wrap(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 10),
          Text(
            'This is not an official transcript. It is for student preview and personal printing only.',
            style: TextStyle(
          ...
          Wrap(
            ...
            children: [
              FilledButton.icon(
                ...
                label: const Text('Print unofficial'),
              ),
              OutlinedButton.icon(
                onPressed: () {},
...
class _RequestTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ListTile(
      ...
      title: Text(
        '${request.requestNo} • ${request.type}',
