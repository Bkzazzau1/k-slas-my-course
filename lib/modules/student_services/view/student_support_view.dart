...
class _StudentSupportViewState extends State<StudentSupportView> {
  ...
  static const _tickets = [
    _SupportTicket(
      ...
      summary:
          'Records is reviewing the result batch and course attempt history.',
      priority: 'High',
    ),
    _SupportTicket(
      ...
      summary:
          'Department admin will review programme curriculum and cohort rules.',
      priority: 'Normal',
    ),
    _SupportTicket(
      ...
      summary:
          'Submission receipt was verified and the lecturer has received the file.',
      priority: 'Low',
    ),
  ];
  ...
  static const _updates = [
    _SupportUpdate(
      ...
      ticketNo: 'KSLAS-SUP-1042',
      detail:
          'Your missing result complaint has been linked to CSC 309 result review.',
      time: 'Today, 12:08',
    ),
    _SupportUpdate(
      ...
      ticketNo: 'KSLAS-SUP-1042',
      detail:
          'A staff member has been assigned to follow up with Records Department.',
      time: 'Today, 11:41',
    ),
    _SupportUpdate(
      ...
      ticketNo: 'KSLAS-SUP-1029',
      detail:
          'Your submission receipt is now visible in your assignment history.',
      time: '03 Jun 2026',
    ),
  ];
          ...
          slivers: [
            ...
            SliverPadding(
              ...
              sliver: SliverList.separated(
                ...
                itemBuilder: (context, index) =>
                    _TicketTile(ticket: _tickets[index]),
              ),
            ),
            SliverPadding(
            ...
            SliverPadding(
              ...
              sliver: SliverList.separated(
                ...
                separatorBuilder: (_, __) => const SizedBox(height: 10),
                itemBuilder: (context, index) =>
                    _UpdateTile(update: _updates[index]),
              ),
            ),
          ],
        ),
        ...
        children: [
          ...
          const TextField(
            ...
            decoration: InputDecoration(
              labelText: 'Describe the issue clearly',
            ),
          ),
          const SizedBox(height: 10),
          OutlinedButton.icon(
            ...
            label: const Text('Attach evidence / screenshot'),
          ),
          const SizedBox(height: 12),
          FilledButton.icon(
            onPressed: () {},
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              CircleAvatar(
                backgroundColor: priorityColor.withValues(alpha: 0.10),
