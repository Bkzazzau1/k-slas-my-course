                ...
                SliverPadding(
                  ...
                  sliver: SliverToBoxAdapter(
                    child: _QuickCourseActions(
                      ...
                      onGraduation: () => Get.toNamed(Routes.graduationMapping),
                    ),
                  ),
                ),
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Text(
          'Courses, registration, academic record, graduation map, support, transcripts, internship, materials, assessments and learning tools organized in one student workspace.',
...
class _QuickCourseActions extends StatelessWidget {
  ...
  final VoidCallback onGraduation;
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(builder: (context, constraints) {
      ...
      return Wrap(spacing: 8, runSpacing: 8, children: [
        ...
        SizedBox(width: width, child: _MiniAction(icon: Icons.map_outlined, label: 'Graduation', onTap: onGraduation)),
