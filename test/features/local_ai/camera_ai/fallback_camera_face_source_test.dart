...
void main() {
  test('FallbackCameraFaceSource should use primary when it succeeds', () async {
  ...
  test('FallbackCameraFaceSource should use fallback after primary failure', () async {
    final source = FallbackCameraFaceSource(
...
CameraImage _fakeImage() {
  return CameraImage.fromPlatformInterface(
    CameraImageData(
      format: CameraImageFormat.raw(ImageFormatGroup.yuv420),
      height: 1,
      width: 1,
